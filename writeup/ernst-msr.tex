...
\caption{Nautilus product, Usability quality. Trend is negative, with some clear spikes after major releases.}
\end{minipage}
\hspace{0.5cm}
\begin{minipage}[b]{0.5\textwidth}
\centering
...
\caption{Evolution product, Efficiency quality. Trend is positive, with some clear spikes before major releases.}
\end{minipage}
\end{figure*}
