...
\begin{minipage}[]{0.5\textwidth}
\centering
\includegraphics[width=\textwidth]{../data/ev-usab-hist.png}
\label{fig:ev-hist}
...
\noindent\textbf{Analysis of key peaks in selected graphs} - The final explanation we explore is that the data are independent of software age, or release cycle, and are instead responding to external events. For example, there may be a usability audit, or a review by a major news source of the performance of the project, etc. Accordingly, we chose two products -- Evolution, a calendar and email application, and Nautilus, a web browser and file manager, for more detailed analysis. We examined Efficiency (including performance) and Usability events for each, choosing a major peak to attempt some historical analysis. Our approach allows us to target our historical analysis more precisely. We looked at peaks centered around the second quarter of 2002 for Nautilus
...
\vspace{-2mm}
%TODO rewrite to show how the second experiment reflects evolution
